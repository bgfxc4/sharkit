var NORMAL_MODE = {
	...
	render_cursor: function () {
		...
		fill(0)
		text(rendered_text_storage[cursor_pos.y][cursor_pos.x], textWidth(rendered_text_storage[cursor_pos.y].substring(0, cursor_pos.x)) + text_size, cursor_pos.y * text_size + text_size)
	},
}
